...
desired_X0 = {
    'wind': [
        ...
        np.array([ 1.35754052e+01,  1.13503634e+01, -3.71662920e-01, -3.51340769e-02,  5.95950278e-02, -3.35673481e-02])
    ],
    'wave': [
        ...
        np.array([ 3.17082450e-04, -1.38894225e-17, -2.95742186e-01, -8.72310676e-19,  1.93838951e-08,  1.12548025e-24])
    ],
    'current': [
        ...
        np.array([ 3.26774469e+00,  8.73389567e-01, -2.97248150e-01,  6.37885901e-04, -2.51092237e-03,  4.13768008e-03])
    ],
    'wind_wave_current': [
        ...
        np.array([ 1.58624551e+01,  1.27043424e+01, -3.85053557e-01, -3.44925458e-02,  5.72341497e-02, -2.85602967e-02])
    ]
}
...
desired_fn = {
    'unloaded': [
        ...
        np.array([0.00769106, 0.00769107, 0.06064407, 0.03840652, 0.03840653, 0.01304348])
    ],
    'loaded': [
        ...
        np.array([0.00960584, 0.00704207, 0.06064868, 0.03818103, 0.03893779, 0.0139098 ])
    ],
}
...
desired_modes = {
    'unloaded': [
        ...
        np.array([[ 9.99999914e-01, -1.34458237e-07,  1.40121284e-08, -1.82835923e-08, -9.89368758e-01, -9.23638107e-12],
                  [-1.63812036e-07, -9.99999914e-01, -1.28405894e-15, -9.89368739e-01,  3.00360851e-10,  1.27230404e-04],
                  [ 1.06977701e-08,  9.17276033e-15, -1.00000000e+00, -2.94761335e-14, -1.32518133e-07,  8.03562600e-13],
                  [-6.80761942e-11, -4.15574791e-04, -1.73878431e-16,  1.45428673e-01, -4.41552784e-11,  1.99498518e-07],
                  [-4.15578910e-04,  5.58781582e-11,  5.60748886e-10, -2.68752940e-09, -1.45428541e-01,  7.82336034e-14],
                  [ 2.21556550e-14,  9.09348107e-08,  5.48964852e-16, -2.63293749e-08,  1.04081494e-15,  9.99999992e-01]])
    ],
    'loaded': [
